...
module.exports = function(defaults) {
  ...
  var vfPage = pickFiles(appTree, { include: ['index.html'] })
  vfPage = concat(vfPage, {
    outputFile: 'pages/' + pkgJson.name + '.page',
  ...
  return mergeTrees([appTree, localPage, package], { overwrite: true });
  // return app.toTree();
};
